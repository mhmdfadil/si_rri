            ...
            <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
                ...
                <div class="px-6 py-4 border-b border-gray-100">
                    <div class="flex items-center justify-center gap-2">
                        @if($program->status == 'draft')
                            <span class="inline-flex items-center gap-2 px-4 py-2 bg-gray-50 text-gray-700 rounded-lg font-medium">
                        ...
                        @elseif($program->status == 'selesai')
                            <span class="inline-flex items-center gap-2 px-4 py-2 bg-blue-50 text-blue-700 rounded-lg font-medium">
                                <span class="w-2.5 h-2.5 bg-blue-500 rounded-full"></span>
                                Selesai
                            </span>
                        @else
                            <span class="inline-flex items-center gap-2 px-4 py-2 bg-orange-50 text-orange-700 rounded-lg font-medium">
                ...
                <div class="px-6 py-4 border-b border-gray-100 space-y-3">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-sm font-semibold text-gray-800">{{ $program->nama_kategori }}</span>
                    </div>
                    <div class="flex items-center justify-between">
                ...
                <div class="p-6 space-y-3">
                    <a
                        ...
                        class="w-full bg-purple-500 text-white px-4 py-3 rounded-lg hover:bg-purple-600 transition-colors font-medium text-sm flex items-center justify-center gap-2"
                    >
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="relative">
                        ...
                        <div id="statusDropdown" class="hidden absolute top-full left-0 right-0 mt-2 bg-white rounded-lg shadow-xl border border-gray-200 z-10">
                            @foreach(\App\Models\Program::STATUS_OPTIONS as $key => $value)
                                ...
                                <form action="{{ route('program.change-status', $program) }}" method="POST">
                                    ...
                                    <button type="submit" class="w-full text-left px-4 py-3 hover:bg-gray-50 transition-colors text-sm text-gray-700 border-b border-gray-100 last:border-0">
                                        {{ $value }}
                                    </button>
                                </form>
                                @endif
                ...
                <div class="p-6">
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label class="text-sm font-medium text-gray-600 block mb-2">Kode Program</label>
                                <div class="bg-gray-50 px-4 py-3 rounded-lg border border-gray-200">
                                    <span class="text-base font-bold text-gray-800">{{ $program->kode_program }}</span>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="bg-gray-50 px-4 py-3 rounded-lg border border-gray-200">
                                    <span class="text-base font-semibold text-gray-800">{{ $program->status_text }}</span>
                                </div>
                            </div>
                        </div>

                        <div>
                            <label class="text-sm font-medium text-gray-600 block mb-2">Nama Program</label>
                            <div class="bg-gray-50 px-4 py-3 rounded-lg border border-gray-200">
                                <span class="text-base font-semibold text-gray-800">{{ $program->nama_program }}</span>
                            </div>
                        </div>

                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label class="text-sm font-medium text-gray-600 block mb-2">Kategori</label>
                                <div class="bg-gray-50 px-4 py-3 rounded-lg border border-gray-200">
                                    <span class="text-base font-semibold text-gray-800">{{ $program->nama_kategori }}</span>
                                </div>
                            </div>

                            <div>
                                <label class="text-sm font-medium text-gray-600 block mb-2">Durasi</label>
                                <div class="bg-gray-50 px-4 py-3 rounded-lg border border-gray-200">
                                    <span class="text-base font-semibold text-gray-800">{{ $program->durasi_formatted }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="bg-gray-50 px-4 py-3 rounded-lg border border-gray-200">
                                <p class="text-base text-gray-800 whitespace-pre-line">{{ $program->deskripsi }}</p>
                            </div>
                        </div>
                        @endif
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-start gap-4 p-4 bg-gray-50 rounded-lg">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-xs text-gray-500 mt-1">{{ $program->created_at->diffForHumans() }}</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4 p-4 bg-gray-50 rounded-lg">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-xs text-gray-500 mt-1">{{ $program->updated_at->diffForHumans() }}</p>
                            </div>
                        </div>
