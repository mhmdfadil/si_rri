        ...
        <form action="{{ route('laporan.konten-siaran') }}" method="GET" class="space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
                ...
                <div>
                    ...
                    <input type="date" name="tanggal_dari" value="{{ request('tanggal_dari') }}" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-100 outline-none">
                </div>

                <!-- Tanggal Sampai -->
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Tanggal Sampai</label>
                    <input type="date" name="tanggal_sampai" value="{{ request('tanggal_sampai') }}" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-100 outline-none">
                </div>

                <!-- Status -->
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Status</label>
                    <select name="status" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-100 outline-none">
                ...
                <div>
                    ...
                    <select name="program_id" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-100 outline-none">
                ...
                <div>
                    ...
                    <select name="tipe_siaran" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-100 outline-none">
            ...
            <div class="flex items-center gap-3 pt-4 border-t border-gray-200">
                <button type="submit" class="bg-blue-500 text-white px-6 py-2.5 rounded-lg hover:bg-blue-600 transition-colors font-medium flex items-center gap-2">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('laporan.konten-siaran') }}" class="bg-gray-100 text-gray-700 px-6 py-2.5 rounded-lg hover:bg-gray-200 transition-colors font-medium flex items-center gap-2">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <table class="w-full">
                <thead class="bg-gray-50 border-b border-gray-200">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-bold text-gray-700 uppercase">Jam</th>
                        <th class="px-6 py-3 text-left text-xs font-bold text-gray-700 uppercase">Durasi</th>
                        <th class="px-6 py-3 text-left text-xs font-bold text-gray-700 uppercase">Tipe</th>
                        <th class="px-6 py-3 text-left text-xs font-bold text-gray-700 uppercase">Status</th>
                        <th class="px-6 py-3 text-left text-xs font-bold text-gray-700 uppercase">Narasumber</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-4 text-sm font-medium text-gray-900">{{ $item->kode_konten }}</td>
                        <td class="px-6 py-4">
                            <p class="text-sm font-medium text-gray-900 line-clamp-2">{{ $item->judul }}</p>
                        </td>
                        <td class="px-6 py-4 text-sm text-gray-700">{{ $item->program->nama_program ?? '-' }}</td>
                        <td class="px-6 py-4 text-sm text-gray-700">{{ $item->tanggal_siaran->format('d/m/Y') }}</td>
                        <td class="px-6 py-4 text-sm text-gray-700">{{ \Carbon\Carbon::parse($item->jam_siaran)->format('H:i') }}</td>
                        <td class="px-6 py-4 text-sm text-gray-700">{{ $item->durasi }} menit</td>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4 text-sm text-gray-700">{{ $item->narasumbers->count() }}</td>
                    </tr>
                    @empty
                    <tr>
