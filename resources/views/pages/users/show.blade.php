...
<div class="max-w-full mx-auto">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-1">
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden transition-colors duration-200">
                ...
                <div class="px-6 pb-6 -mt-12">
                    <div class="text-center">
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">{{ '@' . $user->username }}</p>
            ...
            <!-- Quick Stats -->
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 p-6 mt-6 transition-colors duration-200">
                ...
                <div class="space-y-3">
                    <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                        <span class="text-sm text-gray-600 dark:text-gray-300">Status Akun</span>
                        @if($user->is_active)
                            <span class="text-sm font-medium text-green-600 dark:text-green-400">Aktif</span>
                        @else
                            <span class="text-sm font-medium text-red-600 dark:text-red-400">Non-Aktif</span>
                        @endif
                    </div>
                    <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                        <span class="text-sm text-gray-600 dark:text-gray-300">Bergabung</span>
                        <span class="text-sm font-medium text-gray-800 dark:text-gray-200">{{ $user->created_at->diffForHumans() }}</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="lg:col-span-2 space-y-6">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <p class="text-base font-semibold text-gray-800 dark:text-white bg-gray-50 dark:bg-gray-700/50 px-4 py-3 rounded-lg">
                                {{ $user->name }}
                            </p>
                        </div>
                        ...
                        <!-- Username -->
                        <div>
                            <label class="text-sm font-medium text-gray-600 dark:text-gray-400 block mb-2">Username</label>
                            <p class="text-base font-semibold text-gray-800 dark:text-white bg-gray-50 dark:bg-gray-700/50 px-4 py-3 rounded-lg">
                                {{ $user->username }}
                            </p>
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <p class="text-base font-semibold text-gray-800 dark:text-white bg-gray-50 dark:bg-gray-700/50 px-4 py-3 rounded-lg flex items-center gap-2">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-start gap-4 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">{{ $user->last_login_at->diffForHumans() }}</p>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                            ...
                            <div class="flex-1">
                                <p class="text-sm font-bold text-gray-800 dark:text-white">Akun Dibuat</p>
                                <p class="text-sm text-gray-600 dark:text-gray-300 mt-1">
            ...
            <!-- Actions Card -->
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 p-6 transition-colors duration-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                    ...
                    <form action="{{ route('users.toggle-status', $user) }}" method="POST">
                        ...
                        <button 
                            ...
                            class="w-full bg-orange-50 dark:bg-orange-900/20 border-2 border-orange-200 dark:border-orange-700 text-orange-700 dark:text-orange-400 px-4 py-3 rounded-lg hover:bg-orange-100 dark:hover:bg-orange-900/30 transition-colors font-medium text-sm flex items-center justify-center gap-2"
                        >
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a 
                        href="{{ route('users.edit', $user) }}"
                        class="w-full bg-emerald-50 dark:bg-emerald-900/20 border-2 border-emerald-200 dark:border-emerald-700 text-emerald-700 dark:text-emerald-400 px-4 py-3 rounded-lg hover:bg-emerald-100 dark:hover:bg-emerald-900/30 transition-colors font-medium text-sm flex items-center justify-center gap-2"
                    >
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                        </svg>
