        ...
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            <div class="flex-1">
                <form action="{{ route('users.index') }}" method="GET" class="flex flex-col md:flex-row gap-3">
                    ...
                    <select 
                        name="status" 
                        class="px-4 py-2.5 border border-gray-300 rounded-lg focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100 transition-all outline-none"
                    >
                    ...
                    <button 
                        type="submit" 
                        class="bg-emerald-500 text-white px-6 py-2.5 rounded-lg hover:bg-emerald-600 transition-colors font-medium flex items-center justify-center gap-2"
                    >
                    ...
                    <a 
                        ...
                        class="bg-gray-100 text-gray-700 px-4 py-2.5 rounded-lg hover:bg-gray-200 transition-colors font-medium flex items-center justify-center gap-2"
                    >
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <table class="w-full">
                <thead class="bg-gray-50 border-b border-gray-200">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">Login Terakhir</th>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center">
                            <div class="flex items-center justify-center gap-2">
                                ...
                                <form action="{{ route('users.toggle-status', $user) }}" method="POST" class="inline">
                                    ...
                                    <button 
                                        type="submit" 
                                        class="text-orange-600 hover:text-orange-800 p-1.5 hover:bg-orange-50 rounded transition-colors"
